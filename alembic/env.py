...
# Overwrite the URL in the config with the one from settings
# (This ensures it uses postgresql+asyncpg://...)
...
def do_run_migrations(connection: Connection) -> None:
    """The synchronous wrapper to run migrations."""
...
async def run_async_migrations() -> None:
    ...
    # Use the async connection to run the sync wrapper
